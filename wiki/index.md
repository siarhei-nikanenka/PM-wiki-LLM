...
- [Cases — четыре проектных кейса](sources/cases.md) — раздатка для групповой работы «Стратегия запуска проекта»: задание из семи блоков и четыре контрастных клиентских кейса (Consero, AF Gruppen, Universal, игровой проект) — от 600 до 50 000 часов, от Fixed Price до T&M, включая редкий «fixed time, fixed budget, flex scope». Источник: `raw/papers/Cases.pdf`
